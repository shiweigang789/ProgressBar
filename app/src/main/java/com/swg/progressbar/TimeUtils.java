...
public final class TimeUtils {
    ...
    public static String millis2FitTimeSpan2(long millis) {
...
//        }
        for (int i = 0; i < size; i++) {
            String unit = ":";
            if (millis >= timeList.get(i)) {
                long mode = millis / timeList.get(i);
                millis -= mode * timeList.get(i);
                if (mode < 10) {
                    sb.append(0);
                }
                sb.append(mode);
    ...
    public static String millis2FitTimeSpan(long millis) {
        ...
        int size = 2;
        if (millis > 86400000) {
            units = Arrays.asList(getUnits1());
            timeList.add(0, 3600000);
            timeList.add(0, 86400000);
            size = 4;
        } else if (millis > 3600000) {
            units = Arrays.asList(getUnits2());
            timeList.add(0, 3600000);
            size = 3;
        } else {
            units = Arrays.asList(getUnits3());
        }
        for (int i = 0; i < size; i++) {
    ...
    private static String[] getUnits1() {
        String[] units = {" d ", " h ", " m ", " s ", " ms"};
//        if (I18NUtils.getLanguageType() == 1) {
//            String[] cnunits = {" 天 ", " 时 ", " 分 ", " 秒 ", " 毫秒"};
//            return cnunits;
//        }
        return units;
    }

    private static String[] getUnits2() {
        String[] units = {" h ", " m ", " s ", " ms"};
//        if (I18NUtils.getLanguageType() == 1) {
//            String[] cnunits = {" 时 ", " 分 ", " 秒 ", " 毫秒"};
//            return cnunits;
//        }
        return units;
    }

    private static String[] getUnits3() {
//        String[] units = {" day ", " hour ", " min ", " s ", " ms"};
        String[] units = {" m ", " s ", " ms"};
//        if (I18NUtils.getLanguageType() == 1) {
//            String[] cnunits = {" 分 ", " 秒 ", " 毫秒"};
//            return cnunits;
//        }
        return units;
    }
